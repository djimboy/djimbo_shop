    ...
    if len(get_categories) <= 10:
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ...
                ikb("➡️", callback_data=f"catategory_edit_swipe:{remover + 10}"),
                ikb("⏩", callback_data=f"catategory_edit_swipe:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"catategory_edit_swipe:0"),
                ikb("⬅️", callback_data=f"catategory_edit_swipe:{remover - 10}"),
...
def position_create_swipe_fp(remover) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup(row_width=5)
    ...
    if len(get_categories) <= 10:
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"position_create_swipe:{remover + 10}"),
                ikb("⏩", callback_data=f"position_create_swipe:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"position_create_swipe:0"),
                ikb("⬅️", callback_data=f"position_create_swipe:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
            )
        else:
...
def position_edit_category_swipe_fp(remover) -> InlineKeyboardMarkup:
    ...
    if len(get_categories) <= 10:
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"position_edit_category_swipe:{remover + 10}"),
                ikb("⏩", callback_data=f"position_edit_category_swipe:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"position_edit_category_swipe:0"),
                ikb("⬅️", callback_data=f"position_edit_category_swipe:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
            )
        else:
    ...
    if len(get_positions) <= 10:
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ...
                ikb("➡️", callback_data=f"position_edit_swipe:{category_id}:{remover + 10}"),
                ikb("⏩", callback_data=f"position_edit_swipe:{category_id}:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"position_edit_swipe:{category_id}:0"),
                ikb("⬅️", callback_data=f"position_edit_swipe:{category_id}:{remover - 10}"),
...
def products_add_category_swipe_fp(remover) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup(row_width=5)
    ...
    if len(get_categories) <= 10:
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"products_add_category_swipe:{remover + 10}"),
                ikb("⏩", callback_data=f"products_add_category_swipe:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"products_add_category_swipe:0"),
                ikb("⬅️", callback_data=f"products_add_category_swipe:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
            )
        else:
...
def products_add_position_swipe_fp(remover, category_id) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup(row_width=5)
    ...
    if len(get_positions) <= 10:
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"products_add_position_swipe:{category_id}:{remover + 10}"),
                ikb("⏩", callback_data=f"products_add_position_swipe:{category_id}:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"products_add_position_swipe:{category_id}:0"),
                ikb("⬅️", callback_data=f"products_add_position_swipe:{category_id}:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
            )
        else:
...
def products_item_category_swipe_fp(remover) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup(row_width=5)
    ...
    if len(get_categories) <= 10:
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"buy_category_swipe:{remover + 10}"),
                ikb("⏩", callback_data=f"buy_category_swipe:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
        ...
        if len(get_categories) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"buy_category_swipe:0"),
                ikb("⬅️", callback_data=f"buy_category_swipe:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_categories) / 10)}", callback_data="..."),
            )
        else:
...
def products_item_position_swipe_fp(remover, category_id) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup(row_width=5)
    ...
    if len(get_positions) <= 10:
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
                ikb("➡️", callback_data=f"buy_position_swipe:{category_id}:{remover + 10}"),
                ikb("⏩", callback_data=f"buy_position_swipe:{category_id}:{remover_page}"),
            )
        else:
            keyboard.add(
                ikb(f"1/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
        ...
        if len(get_positions) > 20:
            keyboard.add(
                ikb("⏪", callback_data=f"buy_position_swipe:{category_id}:0"),
                ikb("⬅️", callback_data=f"buy_position_swipe:{category_id}:{remover - 10}"),
                ikb(f"{str(remover + 10)[:-1]}/{math.ceil(len(get_positions) / 10)}", callback_data="..."),
            )
        else:
